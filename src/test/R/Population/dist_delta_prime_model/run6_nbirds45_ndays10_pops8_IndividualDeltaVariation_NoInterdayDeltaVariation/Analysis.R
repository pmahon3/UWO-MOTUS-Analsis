...
coverage_results <- array( dimnames = list(c( 1:CONSTANTS$nPops, "mu_delta_prime")),  colnames = list("coverage"), dim(CONSTANTS$nPops + 1, 1) )
coverage_results
...
for ( i in 1: NPOPS ){
    ...
    simulated_mu_delta_prime_lower = actualParams[CONSTANTS$nBirds + 1, 4]
    simulated_mu_delta_prime_upper = actualParams[CONSTANTS$nBirds + 1, 5]
...
coverage_results[CONSTANTS$nPops + 1] = mu_delta_prime_coverage / CONSTANTS$nPops
